...
class Page(HTMLParser):
    ...
    def check(self):
        ...
        # The homepage festival intro and personal archive use same-origin videos.
        if self.path in {"index.html", "herni-vzpominky/index.html", "masters-of-rock/index.html"}:
